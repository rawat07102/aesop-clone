...
const HeroBanner: React.FunctionComponent = () => {
  return (
    <div className="w-1/2 flex items-center pt-16">
      <div className="flex h-1/2 justify-center items-start w-48">
        <svg
          aria-labelledby="98783f6d-d718-4603-89ae-c2a7d5a98980"
          className="h-9 opacity-70"
          role="img"
          viewBox="0 0 489.7 154.3"
        >
          <title id="98783f6d-d718-4603-89ae-c2a7d5a98980">Aesop logo</title>
          <g>
            <path
      ...
      <div className="flex flex-col h-1/2 w-72">
        <span className="mb-5 opacity-85">For devotees of the metropolis</span>
        <span className="text-3xl mb-5 opacity-80">
          Introducing Parsley Seed Anti-Oxidant Intense Serum
        </span>
        <span className="text-base opacity-80">
          Potent fortification with a weightless texture: a barely-there film to
          guard against airborne particulates.
        </span>
        <button className="transition-colors ease-in mt-5 bg-transparent border-opacity-25 py-4 border-primaryDark border-1 hover:bg-primaryDark hover:text-white">
